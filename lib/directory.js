...
// Assess whether or not the target directory exists.
// If not, return an object that includes additional data about the path -
// what parts of the past do or do not yet exist?
...
// Format the directory name and call a function to check
// if the target directory exists. If not, create it.
